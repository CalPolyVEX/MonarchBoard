...
#define COBS_ENCODE_OK 0x00
#define COBS_ENCODE_NULL_POINTER 0x01
#define COBS_ENCODE_OUT_BUFFER_OVERFLOW 0x02
...
#define    COBS_DECODE_OK                  0x00
#define    COBS_DECODE_NULL_POINTER        0x01
#define    COBS_DECODE_OUT_BUFFER_OVERFLOW 0x02
#define    COBS_DECODE_ZERO_BYTE_IN_INPUT  0x04
#define    COBS_DECODE_INPUT_TOO_SHORT     0x08
 ...
 *                 dst_buf_ptr)
 */
//struct cobs_encode_result cobs_encode(void * dst_buf_ptr, size_t dst_buf_len,
